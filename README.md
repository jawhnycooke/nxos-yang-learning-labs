## Cisco DevNet Learning Labs: NXOS Yang

These self-paced interactive tutorials provide instructions for developers to use NXOS Yang.
...
* Add loopbacks and get serial and capabilities.
* Add NXOS BGP prefixes.
* Add OC loopback, and get OC BGP.
* Do Spine and DevBox setups.
